...
public class Declare_Pageobject_Elements 
{
		 ...
		 * Otherwise it return object count zero
		 */
		@FindBys
		({
					
			@FindBy(tagName="select"),
			@FindBy(className="_9407"),   
		...
		({
			...
			@FindBy(css="input[type='checkbox']"),  //No Checkboxes at page
